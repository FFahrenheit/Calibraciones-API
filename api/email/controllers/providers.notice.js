...
exports.providerNotice = (team, proveedor, siguiente) =>{    
    if(team.length > 1){
    ...
    return {
        subject: `Certificado de ${ proveedor } próximo a expirar [${ shortDate }]`,
        html:
        `
        <!DOCTYPE html
        ...
        <body>
            ...
            <div class="content">
                ...
                <p class="text">
                    ...
                    <span class="marked"> ${ proveedor }</span>
                    está próximo a vencer en 
                    <span class="marked">20 días</span>, 
                    el día <span class="marked"> ${ siguiente }</span> 
                </p>
        
                <p class="text">
                    Por favor, planeen su certificación con <span class="marked">${ proveedor }</span> 
